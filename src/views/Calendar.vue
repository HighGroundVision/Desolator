...
export default {
  ...
  async mounted() {
    ...
    var data = this.schedule.filter(_ => _.region == 2);

    let chartElements = [
      { day: 1, title: 'Monday', element: this.$refs.chartMon, color: '#BD20F0', },
      { day: 2, title: 'Tuesday', element: this.$refs.chartTus, color: '#F02033',  },
      { day: 3, title: 'Wednesday', element: this.$refs.chartWed, color: '#F0CD20',  },
      { day: 4, title: 'Thursday', element: this.$refs.chartThr, color: '#F07F20',  },
      { day: 5, title: 'Friday', element: this.$refs.chartFri, color: '#20F02D',  },
      { day: 6, title: 'Saturday', element: this.$refs.chartSat, color: '#2049F0',  },
      { day: 0, title: 'Sunday', element: this.$refs.chartSun, color: '#20F0CA',  },
    ];
